...
urlpatterns = [
    ...
    path('academic-calendar/<int:event_id>/edit/', views.edit_academic_calendar_event, name='edit_academic_calendar_event'),
    path('academic-calendar/<int:event_id>/delete/', views.delete_academic_calendar_event, name='delete_academic_calendar_event'),
