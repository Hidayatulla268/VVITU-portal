...
urlpatterns = [
    ...
    path('timetable/export-pdf/',views.export_my_timetable_pdf, name='export_my_timetable_pdf'),
    path('timetable/upload-api/',views.upload_my_timetable_api, name='upload_my_timetable_api'),
    ...
    path('respond-proxy/',       views.respond_proxy,      name='respond_proxy'),
    path('reports/',             views.reports,            name='reports'),
    path('export/excel/',        views.export_excel,       name='export_excel'),
    path('export/pdf/',          views.export_pdf,         name='export_pdf'),
    path('counselled-students/', views.counselled_students,name='counselled_students'),
    path('student/<int:student_id>/counselling-report/',     views.student_counselling_report,            name='student_counselling_report'),
    path('student/<int:student_id>/counselling-report/pdf/', views.download_student_counselling_report_pdf, name='download_student_counselling_report_pdf'),
